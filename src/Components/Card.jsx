...
const Card = () => {
    return (
               <div className="p-5 lg:w-1/4 z-20 w-full rounded-2xl mt-10 md-mt-0 " style={{ backgroundColor: "#333333" }}>
            <div className="h-full px-8 py-3   border-gray-300 flex flex-col relative overflow-hidden">
                <h2 className="text-2xl  mb-1 font-semibold text-white border-b border-thin pb-6">Branding & <br /> <span>
                    Identity</span></h2>
