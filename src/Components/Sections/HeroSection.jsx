        ...
        <div className="grid grid-cols-2">
          <div className="w-full py-10">
            ...
            <p className="mb-6 leading-relaxed text-white">
              ...
              used for a variety of shifting design and digital needs that
            ...
            <div className="flex">
              <button className="inline-flex text-white bg-secondaryButton border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded-lg text-md font-semibold">
                GET AN ESTIMATE{" "}
              </button>
              <button className="ml-4 inline-flex text-white bg-primaryButton border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded-lg text-md font-semibold">
                SCHEDULE A DEMO
              </button>
            </div>
          </div>
            ...
            <div className=" px-4  sm:w-1/3  w-full">
              <div className=" px-4 py-6 rounded-lg">
                ...
                <p className="leading-relaxed mt-8 text-sm text-center">
                  As a Design Experience Partner, we supported RentMethod
                  (online rental platform) in a move to acquisition by Airbnb.
                  Victory Dance.
                </p>
              </div>
            </div>
